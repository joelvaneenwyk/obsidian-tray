...
| Hide on launch             | Minimizes Obsidian automatically whenever the app is launched. If the "Run in background" option is enabled, windows will be hidden to the system tray/menubar instead of minimized to the taskbar/dock. | Disabled                       |
